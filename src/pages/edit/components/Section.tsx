      ...
      {({ open }) => (
        <>
          <Disclosure.Button className="cursor-pointer text-xl font-bold mb-2 inline-flex items-center" as="h2">
            {title}
            <svg xmlns="http://www.w3.org/2000/svg" className={`h-4 w-4 mt-1 ml-2 text-gray-400 ${open ? 'transform rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
